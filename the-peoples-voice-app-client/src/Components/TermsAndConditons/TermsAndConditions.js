...
const TermsAndConditions = () => {
  return (
    <Container className="terms-section">
      ...
      <p>Welcome to The People's Voice!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of The People's Voice's Website, located at http://localhost:3000/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use The People's Voice if you do not
      ...
      <p>
        We employ the use of cookies. By accessing The People's Voice, you
        agreed to use cookies in agreement with the The People's Voice's Privacy
        Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, The People's Voice and/or its licensors own the
        intellectual property rights for all material on The People's Voice. All
        intellectual property rights are reserved. You may access this from The
        People's Voice for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from The People's Voice</li>
        <li>Sell, rent or sub-license material from The People's Voice</li>
        <li>Reproduce, duplicate or copy material from The People's Voice</li>
        <li>Redistribute content from The People's Voice</li>
      </ul>
      ...
      <p>
        ...
        People's Voice does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of The People's Voice,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, The People's Voice
      ...
      <p>
        The People's Voice reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant The People's Voice a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of The People's Voice; and (d) the
      ...
      <p>
        ...
        e-mail to The People's Voice. Please include your name, your
      ...
      <p>
        No use of The People's Voice's logo or other artwork will be allowed for
